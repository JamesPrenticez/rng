      ...
      <Grid>
        <div>
          ...
          <ButtonGroup>
            ...
            <Tooltip message="This tooltip appears on the right" position="right">
              <Button className="green">
                Right Tooltip
              </Button>
            </Tooltip>
            
            <Tooltip message="This tooltip appears on the bottom" position="bottom">
        ...
        <EdgeCaseContainer>
          ...
          <div>
            ...
            <ButtonGroup>
              <Tooltip message="This tooltip will adjust its position to stay visible when near edges" position="top">
                <Button className="orange">
                  Edge Detection Test
                </Button>
              </Tooltip>
              
              <Tooltip message="Long tooltip message that demonstrates how the component handles longer text content and wrapping" position="bottom">
